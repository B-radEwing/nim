/* This is an implementation of the game of nim in C. 
 * The game takes two players, who alternate entering their moves on the console.
 * Moves are invokved by "row number" sans quotes. The move 0 0 is a resignation move.
 *
 * Bradley Ewing 
 * March 19, 2015
 */
...
int main(int argc, char *argv[]) {
	...
	exit(0); // execution should never reach this point
}
